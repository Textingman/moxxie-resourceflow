      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            By accessing or using Resource Flow's service ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not access or use the Service.
          </p>
          <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#1F2937' }}>2. Description of Service</h2>
          <p className="mb-6" style={{ color: '#6B7280' }}>
            Resource Flow provides an AI-powered information and education service accessible through www.tryresourceflow.com. The Service is intended for informational purposes only and does not constitute professional advice.
          </p>
          <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#1F2937' }}>3. SMS Communications</h2>
          <p className="mb-4" style={{ color: '#6B7280' }}>
            By opting in to SMS communications, you agree to receive text messages from Resource Flow. Standard message and data rates may apply. You may opt out at any time by replying STOP. For help, reply HELP or contact support@tryresourceflow.com.
          </p>
          <ul className="list-disc pl-6 mb-6 space-y-2" style={{ color: '#6B7280' }}>
            ...
            <li><strong>Promotional Marketing:</strong> Messages about offers, updates, and promotions from Resource Flow.</li>
            ...
            <li>To get help, reply <strong>HELP</strong> or contact <a href="mailto:support@tryresourceflow.com" style={{ color: '#7C3AED' }}>support@tryresourceflow.com</a>.</li>
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            Resource Flow shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use the Service.
          </p>
          <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#1F2937' }}>5. Contact</h2>
          <p className="mb-6" style={{ color: '#6B7280' }}>
            For questions about these Terms, contact us at support@tryresourceflow.com or 4 Peddlers Row #1068, Newark, DE 19702.
          </p>
        </div>
      </section>
      <Footer />
