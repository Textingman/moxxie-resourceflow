            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <a href="mailto:support@tryresourceflow.com" className="text-base font-medium hover:underline" style={{ color: '#7C3AED' }}>support@tryresourceflow.com</a>
                ...
                <div>
                  ...
                  <p style={{ color: '#6B7280' }}>Resource Flow<br />8 The Green, Ste A<br />Dover, DE 19901</p>
                </div>
                <div>
